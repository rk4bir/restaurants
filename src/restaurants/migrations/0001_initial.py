    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_serve_time', models.IntegerField(default=30, verbose_name='mins.')),
                ('min_order_tk', models.FloatField(default=150.0, verbose_name='Tk')),
                ('min_service_charge', models.FloatField(default=30.0, verbose_name='Tk')),
                ('vat_tax', models.FloatField(blank=True, default=0.0, verbose_name='Tk')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star1', models.CharField(default='fa-star-o', max_length=50)),
                ('star2', models.CharField(default='fa-star-o', max_length=50)),
                ('star3', models.CharField(default='fa-star-o', max_length=50)),
                ('star4', models.CharField(default='fa-star-o', max_length=50)),
                ('star5', models.CharField(default='fa-star-o', max_length=50)),
